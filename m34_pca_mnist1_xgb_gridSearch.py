...
parameters = [
    ...
    "max_depth":[4,5,6]},
    {"n_estimators" : [4,5,6], "learning_rate" : [0.1,0.001,0.01],
    "max_depth":[4,5,6], "colsample_bytree":[0.6,0.9,1]},
    {"n_estimators" : [7,8], "learning_rate" : [0.1,0.001,0.5],
    "max_depth":[4,5,6], "colsample_bytree":[0.6,0.9,1],
    "colsample_bylevel":[0.6,0.7,0.9]},
]

# model = XGBClassifier(n_jobs=-1, use_label_encoder=False)
model = GridSearchCV(XGBClassifier(n_jobs=8,use_label_encoder=False), parameters)
