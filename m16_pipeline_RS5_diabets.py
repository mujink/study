...
results : 0.28784433499635964
서치 :  <class 'sklearn.model_selection._search.GridSearchCV'>
results : 0.326921618819775
pip : <function make_pipeline at 0x000002C8F377B310>
서치 :  <class 'sklearn.model_selection._search.RandomizedSearchCV'>
results : 0.3385414583659918
서치 :  <class 'sklearn.model_selection._search.GridSearchCV'>
results : 0.31518645878456963
pip : <class 'sklearn.pipeline.Pipeline'>
서치 :  <class 'sklearn.model_selection._search.RandomizedSearchCV'>
results : 0.3107994395833755
서치 :  <class 'sklearn.model_selection._search.GridSearchCV'>
results : 0.3118273001272114
pip : <function make_pipeline at 0x000002C8F377B310>
서치 :  <class 'sklearn.model_selection._search.RandomizedSearchCV'>
results : 0.31377202340128174
서치 :  <class 'sklearn.model_selection._search.GridSearchCV'>
results : 0.3272949139810908
"""
