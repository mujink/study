...
hist = model.fit(x_train, y_train, epochs=1000, validation_data=(x_val, y_val), batch_size=6, verbose=1, callbacks=[early_stopping])

#4. Evaluate, predict
loss, accuracy = model.evaluate(x_test, y_test, batch_size=6)
...
""" 큰 차이없음.
loss: 0.0845 - acc: 0.9688 - val_loss: 0.1404 - val_acc: 0.8750
loss :  0.06579284369945526
acc :  0.9666666388511658
"""