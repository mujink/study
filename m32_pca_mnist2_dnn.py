...
model.fit(x_train, y_train, epochs=300, verbose=1, validation_split=0.2, batch_size= 256, callbacks=[early_stopping,reduce_lr])
...
pca 154 적용 케라스 Dnn 모델 (0.95이상)
loss :  0.46900224685668945
acc :  0.9743000268936157

pca = PCA(714) (1.0 이상)
loss :  0.5369529128074646
acc :  0.9681000113487244
"""