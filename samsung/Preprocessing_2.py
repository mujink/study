...
x1_prd = datasets.iloc[-5:,:]
x2_prd = codacdbset.iloc[-5:]
x1_prd = x1_prd.to_numpy()
x2_prd = x2_prd.to_numpy()
...
# 리세이프==================================================================================================
x1_train=x1_train.reshape(-1,size,sam_col).astype('float32')
x2_train=x2_train.reshape(-1,size,cdc_col).astype('float32')
x1_test=x1_test.reshape(-1,size,sam_col).astype('float32')
x2_test=x2_test.reshape(-1,size,cdc_col).astype('float32')
x1_val=x1_val.reshape(-1,size,sam_col).astype('float32')
x2_val=x2_val.reshape(-1,size,cdc_col).astype('float32')
x1_prd = x1_prd.reshape(-1,size,sam_col).astype('float32')
x2_prd = x2_prd.reshape(-1,size,cdc_col).astype('float32')
