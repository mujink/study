...
img_l = load_img('../data/image/me2.PNG', target_size=(100,100))
input_img = img_to_array(img_l)
...
plt.show()
# x_pred = np.array(input_img[:,:,0].reshape(1,100,100,3))
x_pred = input_img.reshape(1,100,100,3)
y_pred = 1.0
print(x_pred.shape)
...
# 메시함수 비용이 크다라는 이야기가 있는데 느리다는 말임
def mish(x):
...
modelpath = "../data/modelCheckpoint/keras_81_vgg-my_{epoch:02d}_{val_loss:.4f}.hdf5"  # 가중치 저장 위치
...
# 내 cnn model
# loss : 2.4005258083343506
# acc : 0.6178343892097473
# [[1.]]

# 전이 모델
# loss : 0.6940237879753113
# acc : 0.4968152940273285
# [[0.48201394]]