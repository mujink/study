...
w1 = tf.compat.v1.Variable(tf.compat.v1.random_normal([784,100]), name="weight1")
...
b2 = tf.compat.v1.Variable(tf.compat.v1.random_normal([50]), name="bias2")
layer2 = tf.nn.relu(tf.matmul(layer1, w2) + b2)
# layer2 = tf.nn.dropout(layer2, keep_prob=0.3)

w3 = tf.compat.v1.Variable(tf.compat.v1.random_normal([50,10]), name="weight3")
b3 = tf.compat.v1.Variable(tf.compat.v1.random_normal([10]), name="bias3")
