...
dh = Dropout(0.1)(d1)
dh = Dense(500, activation='relu')(dh)
dh = Dropout(0.1)(dh)
dh = Dense(500, activation='relu')(dh)
dh = Dropout(0.1)(dh)
dh = Dense(500, activation='relu')(dh)
...
model.fit(
    x_train,y_train,
    epochs=1000, batch_size= 10, validation_data=(x_val, y_val), verbose=2, callbacks=[early_stopping])
...
"""
Dropout (너무 많이 줄였음 0.2)
loss :  16.991928100585938
mae :  2.659029245376587
RMSE : 4.122126008917869
RMSE : 16.99192283339716
R2 : 0.7627968323706604
...
ropout (너무 많이 줄였음 0.1)
loss :  13.841684341430664
mae :  2.5528340339660645
RMSE : 3.7204423956739734
RMSE : 13.841691619528294
R2 : 0.8067733046052109
"""