...
model = Sequential()
model.add(Conv1D(1,3 ,input_shape=(x_train.shape[1],1) ,padding='same'))
...
# modelpath = "../data/modelCheckPoint/k46_MC-8_{epoch:02d}_{val_los/s:.4f}.hdf5"  # 가중치 저장 위치
...
""" c1d
loss :  0.11048256605863571
acc :  0.9722222089767456
R2 : 0.9113020208237216
"""