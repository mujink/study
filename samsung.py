...
# x_prd = datasets.iloc[-size:,:col].values
...
# hist = model.fit(x_train,y_train, validation_data=(x_val,y_val),epochs=10000,batch_size=128,verbose=2,callbacks=[es,cp], shuffle=False)
